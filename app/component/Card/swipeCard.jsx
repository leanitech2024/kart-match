...
//                                         <PiForkKnifeBold size={20} className="gap-1 text-orange-500" />
...
//                                 <div className="flex flex-col items-center bg-gray-200 p-2 rounded-lg">
//                                     <div className="flex items-center gap-1">
//                                         <FaRegStar size={20} className="gap-1 text-yellow-500" />
...
//                                 <div className="flex flex-col items-center bg-gray-200 p-2 rounded-lg">
//                                     <div className="flex items-center gap-1">
//                                         <FaHotel size={20} className="gap-1 text-orange-400" />
