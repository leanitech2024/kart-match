...
const Hero = () => {
    return (
        <section className="bg-[#F51F1F] mt-10 min-h-screen flex items-center justify-center px-6 md:px-16 text-black w-full overflow-hidden">
            <div className="flex flex-col md:flex-row items-center justify-between max-w-6xl w-full mx-auto">

                {/* Left Side Content */}
                <div className="md:w-1/2 flex flex-col mt-48 items-start text-left space-y-4">
